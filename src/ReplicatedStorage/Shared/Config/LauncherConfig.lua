...
LauncherConfig.Types = {
	SupportLauncher = {
		...
		iconId = "rbxassetid://0",
		stats = { maxHP = 18000, baseDamage = 900, armor = 0, regen = 1, speed = 15.5, launchPower = 1.0, control = 1.05, launchSpeed = 40 },
	...
	StunLauncher = {
		...
		iconId = "rbxassetid://0",
		stats = { maxHP = 20000, baseDamage = 1000, armor = 0, regen = 1, speed = 15.5, launchPower = 1.0, control = 1.0, launchSpeed = 50 },
		passiveAbility = { type = "None", params = {} },
	...
	VacuumLauncher = {
		...
		iconId = "rbxassetid://0",
		stats = { maxHP = 15000, baseDamage = 800, armor = 0, regen = 1, speed = 16.2, launchPower = 0.95, control = 1.1, launchSpeed = 52 },
		passiveAbility = { type = "None", params = {} },
		collisionAbility = {},
	},
	StealthLauncher = {
		...
		iconId = "rbxassetid://0",
		stats = { maxHP = 13000, baseDamage = 1200, armor = 0, regen = 1, speed = 18, launchPower = 1.05, control = 1.15, launchSpeed = 60 },
		passiveAbility = { type = "None", params = {} },
		collisionAbility = {},
	},
	HealLauncher = {
		...
		iconId = "rbxassetid://0",
		stats = { maxHP = 18000, baseDamage = 800, armor = 0, regen = 1.1, speed = 15, launchPower = 0.95, control = 1.05, launchSpeed = 45 },
	...
	BonusBuffLauncher = {
		...
		iconId = "rbxassetid://0",
		stats = { maxHP = 22000, baseDamage = 1200, armor = 0.15, regen = 1.1, speed = 17, launchPower = 1.1, control = 1.05, launchSpeed = 40 },
	...
	PetrifyLauncher = {
		...
		iconId = "rbxassetid://0",
		stats = { maxHP = 20000, baseDamage = 900, armor = 0, regen = 1, speed = 15, launchPower = 1.0, control = 1.1, launchSpeed = 45 },
		passiveAbility = { type = "None", params = {} },
	...
	FireLauncher = {
		...
		iconId = "rbxassetid://0",
		stats = { maxHP = 14000, baseDamage = 1200, armor = 0, regen = 1, speed = 17, launchPower = 1.1, control = 0.95, launchSpeed = 55 },
		passiveAbility = { type = "None", params = {} },
	...
	PoisonLauncher = {
		...
		iconId = "rbxassetid://0",
		stats = { maxHP = 15000, baseDamage = 900, armor = 0, regen = 1, speed = 16.5, launchPower = 1.0, control = 1.05, launchSpeed = 52 },
		passiveAbility = { type = "None", params = {} },
