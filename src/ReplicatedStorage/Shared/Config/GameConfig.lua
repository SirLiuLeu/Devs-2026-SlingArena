...
local GameConfig = {
	FlagConfig = {
		...
		Slow = { Duration = 3, Priority = 50, Stackable = true, MaxStack = 3, SlowAmount = 0.25, RefreshOnly = true },
		...
		LavaTrap = { Duration = 10, Stackable = true, MaxStack = 10, TickInterval = 0.5, DamagePerTick = { Mode = "MaxHPPercent", Percent = 0.2, Fallback = 2000 } },
	},
}
