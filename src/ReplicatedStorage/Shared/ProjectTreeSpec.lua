...
local ProjectTreeSpec = {
	UI = {
		...
		LauncherInventory = {
			...
			UpgradeButton = "LauncherInventoryUI.Root.BodyLauncher.RightPanel.ActionButtons.Upgrade",
			Level = "LauncherInventoryUI.Root.BodyLauncher.RightPanel.Level",
			StatDamage = "LauncherInventoryUI.Root.BodyLauncher.RightPanel.Stats.Damage",
			StatHP = "LauncherInventoryUI.Root.BodyLauncher.RightPanel.Stats.HP",
			StatRange = "LauncherInventoryUI.Root.BodyLauncher.RightPanel.Stats.Range",
			StatRegen = "LauncherInventoryUI.Root.BodyLauncher.RightPanel.Stats.Regen",
		},
