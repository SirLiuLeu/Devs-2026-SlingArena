...
local ProjectTreeSpec = {
	UI = {
		...
		MainHub = {
			...
			QuickHPTime = "MainHUD.Root.QuickHP.Time", -- [PROJECT_TREE_SPEC] StarterGui.MainHUD.Root.QuickHP.Time (TextLabel)
			QuickHPOverlay = "MainHUD.Root.QuickHP.Overlay", -- [PROJECT_TREE_SPEC] StarterGui.MainHUD.Root.QuickHP.Overlay (Frame)
		...
		LauncherInventory = {
			...
			ToggleEquipButton = "LauncherInventoryUI.Root.BodyLauncher.RightPanel.ActionButtons.ToggleEquipButton",
		...
		Inventory = {
			...
			Root = "InventoryUI.Root",
			BodyItems = "InventoryUI.Root.BodyItems",
			BodyEquipment = "InventoryUI.Root.BodyEquipment",
			ItemsTab = "InventoryUI.Root.Tabs.ItemsTab",
			EquipmentTab = "InventoryUI.Root.Tabs.EquipmentTab",
			CloseButton = "InventoryUI.Root.Header.CloseButton",
			ItemsGridContainer = "InventoryUI.Root.BodyItems.GridContainer",
			EquipmentGridContainer = "InventoryUI.Root.BodyEquipment.GridContainer",
			EquipmentCapacityLabel = "InventoryUI.Root.BodyEquipment.Footer.CapacityLabel",
			ItemsSelectedName = "InventoryUI.Root.BodyItems.RightPanel.SelectedName",
			ItemsUseButton = "InventoryUI.Root.BodyItems.RightPanel.ActionButtons.UseButton",
			ItemsStat1 = "InventoryUI.Root.BodyItems.RightPanel.Stats.ItemStat1",
			ItemsStat2 = "InventoryUI.Root.BodyItems.RightPanel.Stats.ItemStat2",
			ItemsStat3 = "InventoryUI.Root.BodyItems.RightPanel.Stats.ItemStat3",
			EquipmentSelectedName = "InventoryUI.Root.BodyEquipment.RightPanel.SelectedName",
			EquipmentToggleEquipButton = "InventoryUI.Root.BodyEquipment.RightPanel.ActionButtons.ToggleEquipButton",
	...
	Remotes = {
		...
		ConsumeHpPotion = "LauncherArenaRemotes.ConsumeHpPotion", -- legacy compatibility
		ConsumeItem = "LauncherArenaRemotes.ConsumeItem", -- generic server-authoritative item consumption
		...
		ApplySelfBounce = "LauncherArenaRemotes.ApplySelfBounce", -- [PROJECT_TREE_SPEC]
		ApplyKnockback = "LauncherArenaRemotes.ApplyKnockback", -- [PROJECT_TREE_SPEC]
