...
function WaitForUI.ResolveLauncherControlUI(player: Player, _options: ResolveOptions?): ScreenGui?
...
function WaitForUI.ResolveLauncherControlUIWithRetry(player: Player, options: ResolveOptions?): ScreenGui?
	local resolved = WaitForUI.ResolveLauncherControlUI(player, options)
