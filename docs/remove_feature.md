...
## System cos nhiều Attribute hơn trong rule design
## PlayerStateService
...
## RoundService - loại bỏ hoàn toàn roundService và thay thế bằng logic mới (do gameplay đã thay đổi gần như hoàn toàn)
...
- **Feature Name:** EXP from raw damage dealt.
  ...
  ## FoodService - Code lại theo rule design
